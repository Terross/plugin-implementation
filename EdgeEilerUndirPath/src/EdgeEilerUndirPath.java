...
public class EdgeEilerUndirPath implements GraphProperty 
{	/**Реализует задачу класса: <p>Сортирует отмеченные метками рёбра и проверяет, образуют ли они эйлеров путь
	 * @param graph - неориентированный граф
	 * @return ответ на вопрос образует ли указанный порядок обхода рёбер эйлеров путь
	 */
	@Override
